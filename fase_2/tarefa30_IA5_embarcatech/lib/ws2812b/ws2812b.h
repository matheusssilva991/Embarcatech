 ...
 *
 * @note A sequência de cores é GRB (não RGB) - específico do protocolo WS2812B
 * @note Use ws2812b_write() para aplicar mudanças após modificar cores
 *
 * Exemplo de uso:
 * @code
 *   ws2812b_init();
 *   ws2812b_set_led(0, 255, 0, 0);
 *   ws2812b_write();
 * @endcode
 */
...
// Constantes pré-definidas de cores (R, G, B)
#define COLOR_RED {255, 0, 0}       ///< Vermelho puro
#define COLOR_GREEN {0, 255, 0}     ///< Verde puro
#define COLOR_BLUE {0, 0, 255}      ///< Azul puro
#define COLOR_WHITE {255, 255, 255} ///< Branco puro
#define COLOR_BLACK {0, 0, 0}       ///< Preto (desligado)
#define COLOR_YELLOW {255, 255, 0}  ///< Amarelo (Verde + Vermelho)
#define COLOR_CYAN {0, 255, 255}    ///< Ciano (Verde + Azul)
#define COLOR_MAGENTA {255, 0, 255} ///< Magenta (Vermelho + Azul)
 ...
 * @param color Array RGB com 3 elementos [R, G, B] (0-255 cada)
 *
 ...
 *
 * Exemplo: int cor[3] = {255, 0, 0}; // Vermelho
 */
 ...
 * @param point_index Índice do LED (0-24)
...
/**
 * @brief Preenche uma linha inteira com uma cor
 * @param row Número da linha (0-4)
 * @param color Array RGB com 3 elementos [R, G, B] (0-255 cada)
 *
 * Define todos os 5 LEDs da linha especificada com a mesma cor.
 * Use ws2812b_write() para aplicar as mudanças.
 */
 ...
 * @param color Array RGB com 3 elementos [R, G, B] (0-255 cada)
 *
 * Define todos os 25 LEDs da matriz com a mesma cor.
 * Atualiza imediatamente os LEDs via ws2812b_write().
 */
